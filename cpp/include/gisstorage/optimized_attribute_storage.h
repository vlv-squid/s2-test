...
#ifndef OPTIMIZED_ATTRIBUTE_STORAGE_H
#define OPTIMIZED_ATTRIBUTE_STORAGE_H
...
namespace GisStorage {
    ...
    // 优化的属性数据存储类 - 集成字符串池
    class OptimizedAttributeStorage {
      public:
        explicit OptimizedAttributeStorage(const std::string& attribute_file, const std::string& string_pool_file);
      ...
      private:
        ...
        OptimizedAttributeSerializer serializer_;
...
#endif // OPTIMIZED_ATTRIBUTE_STORAGE_H

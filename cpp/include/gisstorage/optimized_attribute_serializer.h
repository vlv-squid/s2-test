...
#ifndef OPTIMIZED_ATTRIBUTE_SERIALIZER_H
#define OPTIMIZED_ATTRIBUTE_SERIALIZER_H
...
namespace GisStorage {
    ...
    // 优化的属性序列化器类 - 集成字符串池
    class OptimizedAttributeSerializer {
      public:
        OptimizedAttributeSerializer();
...
#endif // OPTIMIZED_ATTRIBUTE_SERIALIZER_H

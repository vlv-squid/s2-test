...
#ifndef OPTIMIZED_SHAPEFILE_CONVERTER_H
#define OPTIMIZED_SHAPEFILE_CONVERTER_H

#include "types.h"
#include "geometry_storage.h"
#include "optimized_attribute_storage.h"
#include "optimized_attribute_serializer.h"
...
namespace GisStorage {
    ...
    // 优化的Shapefile转换器类 - 集成字符串池
    class OptimizedShapefileConverter {
      public:
        OptimizedShapefileConverter(const std::string& shapefile_path, const std::string& output_dir);
        ...
        // 获取压缩统计信息
        OptimizedAttributeSerializer::CompressionStats getCompressionStats() const;
      ...
      private:
        ...
        std::unique_ptr<OptimizedAttributeStorage> attribute_storage_;
...
#endif // OPTIMIZED_SHAPEFILE_CONVERTER_H
